---
title: Rotate to Location
---

# Rotate to Location

import createGlobe from "glowglobe";
import { useEffect, useRef } from "react";

export function glowglobe() {
...
Transforming longitude and latitude to angles, and controlling the animation direction by comparing current angles to the target.

[View source of this example on GitHub](https://github.com/millionscope/glowglobe/blob/main/website/pages/docs/showcases/rotate-to-location.mdx)
